        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-body">
                    <p style="font-size: 145%"><strong><i class="fa fa-life-ring" aria-hidden="true"></i> Support - Job Seekers FAQ</strong></p>
                </div>
            </div>
            <div class="panel panel-default">
                <div class="panel-heading"><strong>Setting An Account</strong></div>
                <div class="panel-body">
                    <p><strong>I forgot my password. What can I do?</strong></p>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <p><strong>What does JobsAustralia.tech do with my application?</strong></p>
