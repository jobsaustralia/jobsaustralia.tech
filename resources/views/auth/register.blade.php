                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('autohotkey') ? ' has-error' : '' }}">
                            <label for="autohotkey" class="col-md-4 control-label">AutoHotKey</label>
                        ...
                        <div class="form-group{{ $errors->has('fsharp') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-1">
                                ...
                                <input id="fsharp" type="checkbox" class="form-control" name="fsharp" value="{{ old('fsharp', 1) }}">
                        ...
                        <div class="form-group{{ $errors->has('rust') ? ' has-error' : '' }}">
                            <label for="ruby" class="col-md-4 control-label">Rust</label>
                        ...
                        <div class="form-group{{ $errors->has('vue') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-1">
                                ...
                                <input id="vue" type="checkbox" class="form-control" name="vue" value="{{ old('vue', 1) }}">
                        ...
                        <div class="form-group{{ $errors->has('webassembly') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-1">
                                ...
                                <input id="webassembly" type="checkbox" class="form-control" name="webassembly" value="{{ old('webassembly', 1) }}">
                        ...
                        <div class="form-group{{ $errors->has('dns') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-1">
                                ...
                                <input id="dns" type="checkbox" class="form-control" name="dns" value="{{ old('dns', 1) }}">
                        ...
                        <div class="form-group{{ $errors->has('docker') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-1">
                                ...
                                <input id="docker" type="checkbox" class="form-control" name="docker" value="{{ old('docker', 1) }}">
