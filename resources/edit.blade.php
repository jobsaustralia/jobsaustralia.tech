        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
						...
						<div class="form-group{{ $errors->has('python') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-1">
                                <input id="python" type="checkbox" class="form-control" name="python" value="1" autofocus>
						...
						<div class="form-group{{ $errors->has('c') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-1">
                                <input id="c" type="checkbox" class="form-control" name="c" value="1" autofocus>
						...
						<div class="form-group{{ $errors->has('csharp') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-1">
                                <input id="csharp" type="checkbox" class="form-control" name="csharp" value="1" autofocus>
						...
						<div class="form-group{{ $errors->has('cplus') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-1">
                                <input id="cplus" type="checkbox" class="form-control" name="cplus" value="1" autofocus>
						...
						<div class="form-group{{ $errors->has('php') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-1">
                                <input id="php" type="checkbox" class="form-control" name="php" value="1" autofocus>
						...
						<div class="form-group{{ $errors->has('html') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-1">
                                <input id="html" type="checkbox" class="form-control" name="html" value="1" autofocus>
						...
						<div class="form-group{{ $errors->has('css') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-1">
                                <input id="css" type="checkbox" class="form-control" name="css" value="1" autofocus>
						...
						<div class="form-group{{ $errors->has('javascript') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-1">
                                <input id="javascript" type="checkbox" class="form-control" name="javascript" value="1" autofocus>
						...
						<div class="form-group{{ $errors->has('sql') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-1">
                                <input id="sql" type="checkbox" class="form-control" name="sql" value="1" autofocus>
						...
						<div class="form-group{{ $errors->has('unix') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-1">
                                <input id="unix" type="checkbox" class="form-control" name="unix" value="1" autofocus>
						...
						<div class="form-group{{ $errors->has('winserver') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-1">
                                <input id="winserver" type="checkbox" class="form-control" name="winserver" value="1" autofocus>
						...
						<div class="form-group{{ $errors->has('windesktop') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-1">
                                <input id="windesktop" type="checkbox" class="form-control" name="windesktop" value="1" autofocus>
						...
						<div class="form-group{{ $errors->has('linuxdesktop') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-1">
                                <input id="linuxdesktop" type="checkbox" class="form-control" name="linuxdesktop" value="1" autofocus>
						...
						<div class="form-group{{ $errors->has('macosdesktop') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-1">
                                <input id="macosdesktop" type="checkbox" class="form-control" name="macosdesktop" value="1" autofocus>
						...
						<div class="form-group{{ $errors->has('pearl') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-1">
                                <input id="pearl" type="checkbox" class="form-control" name="pearl" value="1" autofocus>
						...
						<div class="form-group{{ $errors->has('bash') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-1">
                                <input id="bash" type="checkbox" class="form-control" name="bash" value="1" autofocus>
						...
						<div class="form-group{{ $errors->has('batch') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-1">
                                <input id="batch" type="checkbox" class="form-control" name="batch" value="1" autofocus>
						...
						<div class="form-group{{ $errors->has('cisco') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-1">
                                <input id="cisco" type="checkbox" class="form-control" name="cisco" value="1" autofocus>
						...
						<div class="form-group{{ $errors->has('office') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-1">
                                <input id="office" type="checkbox" class="form-control" name="office" value="1" autofocus>
						...
						<div class="form-group{{ $errors->has('r') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-1">
                                <input id="r" type="checkbox" class="form-control" name="r" value="1" autofocus>
						...
						<div class="form-group{{ $errors->has('go') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-1">
                                <input id="go" type="checkbox" class="form-control" name="go" value="1" autofocus>
						...
						<div class="form-group{{ $errors->has('ruby') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-1">
                                <input id="ruby" type="checkbox" class="form-control" name="ruby" value="1" autofocus>
						...
						<div class="form-group{{ $errors->has('asp') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-1">
                                <input id="asp" type="checkbox" class="form-control" name="asp" value="1" autofocus>
						...
						<div class="form-group{{ $errors->has('scala') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-1">
                                <input id="scala" type="checkbox" class="form-control" name="scala" value="1" autofocus>
